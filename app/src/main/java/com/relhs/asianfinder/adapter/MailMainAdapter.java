...
public class MailMainAdapter extends BaseAdapter {

    private final ImageLoader imageLoader;
    private Context context;
    private ArrayList<MailMainItem> navDrawerItems;

    public MailMainAdapter(Context context, ArrayList<MailMainItem> navDrawerItems, ImageLoader imageLoader) {
    ...
    @Override
    public MailMainItem getItem(int position) {
...
//        if(!navDrawerItems.get(position).getCount().equalsIgnoreCase("")) { // not empty
