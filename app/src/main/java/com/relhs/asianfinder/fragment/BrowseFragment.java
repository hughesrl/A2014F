...
public class BrowseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Spinner spinnerShowPeople = (Spinner) myFragmentView.findViewById(R.id.spinnerShowPeople);
        CustomAdapter adapterSpinnerShowPeople = new CustomAdapter(getActivity(), android.R.layout.simple_spinner_item, populateShowPeopleFilter());
        spinnerShowPeople.setAdapter(adapterSpinnerShowPeople);
        spinnerShowPeople.setSelection(0);

        spinnerShowPeople.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
...
//        private JSONArray android;
    ...
    public static ArrayList<SpinnerItems> populateShowPeopleFilter(){
        ...
        spinnerItems.add(new SpinnerItems("Who\'s Online", "whosonline", true));
        spinnerItems.add(new SpinnerItems("Most Popular", "mostpopular", true));
        spinnerItems.add(new SpinnerItems("New Members", "newmembers", true));
        spinnerItems.add(new SpinnerItems("Male", "male", true));
        spinnerItems.add(new SpinnerItems("Female", "female", true));
        spinnerItems.add(new SpinnerItems("Transgender", "transgender", true));
        return spinnerItems;
    }
