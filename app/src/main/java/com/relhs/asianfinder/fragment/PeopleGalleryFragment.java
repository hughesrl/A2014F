...
public class PeopleGalleryFragment extends Fragment {
    ...
    public static PeopleGalleryFragment newInstance(int sectionNumber, double longitude, double latitude) {
        PeopleGalleryFragment fragment = new PeopleGalleryFragment();
