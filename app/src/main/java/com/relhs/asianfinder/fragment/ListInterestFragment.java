...
public class ListInterestFragment extends ListFragment {
    ...
    public static ListInterestFragment newInstance(int sectionNumber, double longitude, double latitude) {
        ListInterestFragment fragment = new ListInterestFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        customAdapter = new MyListCursorAdapter(
                getActivity(),
                myListOperations.getMyListByType(Constants.TAG_MYLIST_INTEREST),
                myListOperations,
                0);
