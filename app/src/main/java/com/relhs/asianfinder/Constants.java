...
//    public final static String TAG_PROFILE = "accounts";public final static String TAG_PROFILE = "accounts";
    ...
    public final static String TAG_COUNTRY_NAME= "name";
    public final static String TAG_COUNTRY_CODE1= "alpha_2";
    public final static String TAG_COUNTRY_CODE2= "alpha_3";

    public final static String TAG_REGION_NAME= "region";

    public final static String TAG_CITY_ID= "id";
    public final static String TAG_CITY_POSTAL_CODE= "postalcode";
    public final static String TAG_CITY_NAME= "city";
    public final static String TAG_CITY_STATE= "state";
    public final static String TAG_CITY_REGION= "region";


    // BUSINESS
    public final static String TAG_BUSNAME= "business_name";
    public final static String TAG_BUSCATEGORY= "business_category";
    public final static String TAG_BUSOWNERSHIP= "business_ownership";
    public final static String TAG_BUSIMAGEFILE= "image_filename";
    public final static String TAG_BUSIMAGEWIDTH= "image_width";
    public final static String TAG_BUSIMAGEHEIGHT= "image_height";
    public final static String TAG_BUSTILESIZE= "image_tile_size";
    public final static String TAG_BUSSOURCE= "source";
    public final static String TAG_BUSID= "id";
    public final static String TAG_BUSLATITUDE= "lat";
    public final static String TAG_BUSLONGITUDE= "lng";
    public final static String TAG_BUSDISTANCE= "distance";

    // CATEGORIES

    public final static String TAG_CATEGORYID= "id";
    public final static String TAG_CATEGORYNAME= "name";
    public final static String TAG_CATEGORYICON= "icon";
    public final static String TAG_CATEGORYTILE= "tile";
    public final static String TAG_CATEGORYTHEME= "theme";
    public final static String TAG_CATEGORYCHILDS= "child";

    // SUBCATEGORIES
    public final static String TAG_SUBCATEGORYID1= "id1";
    public final static String TAG_SUBCATEGORYID2= "id2";
